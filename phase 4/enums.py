...
explicitly in the Alembic migrations (single source of truth for DDL).
...
class SignalStatus(str, enum.Enum):
    ...
    CANCELLED = "CANCELLED"
    CLOSED = "CLOSED"
    # Phase 4: classification stands, but the risk plan failed validation.
...
execution_mode_enum = _pg(ExecutionMode, "execution_mode")
