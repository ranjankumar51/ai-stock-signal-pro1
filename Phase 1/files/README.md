# AI Stock Signal Pro — Backend (Phases 0–1)

Foundational backend infrastructure (Phase 0) plus **market-data ingestion**
(Phase 1). **No UI, no sentiment, no technical indicators, no scoring/signal
logic** — those arrive in later phases.
...
Technical indicators, FinBERT/sentiment, scoring/fusion, signal generation,
trade tracking, fundamentals/news adapters, and the Electron client.
