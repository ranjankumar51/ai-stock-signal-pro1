"""Social dimension — Phase 3 plug-in placeholder.

Implements the ScoreProvider contract but reports ``available=False`` so it is
excluded from the fuse. Replace with the real social engine in a later phase; no
...
class SocialScoreProvider(ScoreProvider):
